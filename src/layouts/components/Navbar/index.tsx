...
// Declaring props types for Navbar
interface Props {
  routes: {
    [key: string]:
      | ReactNode
...
function Navbar({ routes, brand, transparent, light, action }: Props): JSX.Element {
                  ...
                  <Fragment key={col.name}>
                    ...
                    {col.collapse.map((item: any) => (
                      <MDTypography
                        ...
                        py={0.625}
                        px={2}
                        sx={({ palette: { grey, dark }, borders: { borderRadius } }: Theme | any) => ({
      ...
      {({ TransitionProps }) => (
        <NewGrow
          ...
          sx={{
            ...
            background: ({ palette: { white } }: Theme | any) => white.main,
          }}
        >
